...
class PatientsPage(QWidget):
    ...
    def display_students(self):
        ...
        try:
            ...
            for row_idx, stud in enumerate(students):
                ...
                """)
                view_btn.clicked.connect(lambda _, s_id=stud[0]: self.view_student(s_id))
                ...
                self.students_table.setCellWidget(row_idx, 5, view_btn_widget)
    ...
    def edit_student(self, stud_id):
        ...
        try:
            ...
            status_index = self.status_input.findText(student[13])
            ...
            if hr:
                ...
                self.hr_height.setText(str(hr[1]))  # changed from setValue to setText
                self.hr_weight.setText(str(hr[2]))  # changed from setValue to setText
                self.hr_allergies.setText(hr[3])
                self.hr_notes.setPlainText(hr[4])
            else:
                self.hr_date_recorded.setDate(QDate.currentDate())
                self.hr_height.setText("30")
                self.hr_weight.setText("5")
    ...
    def clear_form(self):
        ...
        self.hr_date_recorded.setDate(QDate.currentDate())
        self.hr_height.setText("30")  # <-- FIXED
        self.hr_weight.setText("5")  # <-- FIXED
        self.hr_allergies.clear()
        self.hr_notes.clear()
        self.medhist_table.setRowCount(0)
